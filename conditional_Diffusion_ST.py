...
checkpoint = torch.load(
    f'../../model/conditionDiff/ST/ckpt_26_checkpoint.pt', map_location=device)
...
for epc in range(26, params['epochs']):
    ...
    with torch.no_grad():
        ...
        torch.save(
            checkpoint, f'../../model/conditionDiff/ST/ckpt_{epc+1}_checkpoint.pt')
