...
class_list = ['BRLC/유형3', 'BRDC/유형5','BRIL/유형9', 'BRID/유형12', 'BRID/유형13']
...
checkpoint = torch.load(
    f'../../model/conditionDiff/color_scratch_details/BR_in/ckpt_513_checkpoint.pt', map_location=device)
...
while (True):
    ...
    with torch.no_grad():
        ...
        for i in range(len(lab)):
            ...
            img_pil.save(
                params['data_path']+f'{class_list[lab[i]]}/NIA_S_{class_list[lab[i]][:4]}_{class_list[lab[i]][7:]}_{str(count[class_list[lab[i]]]).zfill(6)}.jpeg')
